/*						%IF &CUSTOMER_OL_STATUS. = NOT_COMPLETE AND &CUSTOMER_OL_RUN_DATE. = . %THEN*/
/*							%DO; */
								...
								/*KICK OFF OL_CUSTOMER*/
								SYSTASK COMMAND "'C:\PROGRAM FILES\SASHOME\SASFOUNDATION\9.4\SAS.EXE'
												 '&CUST_FILE_PATH.\CUSTDM_7_ONLINE_INPUT.SAS'
												 -LOG '&CUST_LOGPATH.\ONLINE_CUST_&TIMESTAMP..LOG'
												 -CONFIG 'C:\PROGRAM FILES\SASHOME\SASFOUNDATION\9.4\SASV9.CFG'"
								TASKNAME=OL_CUSTOMER
								STATUS=OL_CUSTOMER;

								WAITFOR _ALL_ OL_CUSTOMER;
