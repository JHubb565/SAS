/*						%IF &CUSTOMER_QF1QF2_STATUS. = NOT_COMPLETE AND &CUSTOMER_QF1QF2_RUN_DATE. = . %THEN*/
/*							%DO; */
								...
								/*KICK OFF QFUND1_QFUND2_CUSTOMER*/
								SYSTASK COMMAND "'C:\PROGRAM FILES\SASHOME\SASFOUNDATION\9.4\SAS.EXE'
												'&CUST_FILE_PATH.\CUSTDM_2_QF1_QF2_INPUT.SAS'
												-LOG '&CUST_LOGPATH.\QF1QF2_CUST_&TIMESTAMP..LOG'
												-CONFIG 'C:\PROGRAM FILES\SASHOME\SASFOUNDATION\9.4\SASV9.CFG'"
								TASKNAME=QF1QF2_CUSTOMER
								STATUS=QF1QF2_CUSTOMER;

								WAITFOR _ALL_ QF1QF2_CUSTOMER;
