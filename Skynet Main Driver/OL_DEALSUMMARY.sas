/*						%IF &DEAL_OL_STATUS. = NOT_COMPLETE AND &DEAL_OL_RUN_DATE. = . %THEN*/
/*							%DO; */
								...
								SYSTASK COMMAND "'C:\PROGRAM FILES\SASHOME\SASFOUNDATION\9.4\SAS.EXE'
												 '&DEAL_FILE_PATH.\SKYNET_STEP_14_ONLINE.SAS'
												 -LOG '&DEAL_LOGPATH.\ONLINE_DS_&TIMESTAMP..LOG'
								...
								/*KICK OFF LOC_DEAL*/
								SYSTASK COMMAND "'C:\PROGRAM FILES\SASHOME\SASFOUNDATION\9.4\SAS.EXE'
												 '&DEAL_FILE_PATH.\SKYNET_STEP_15_LOC.SAS'
												 -LOG '&DEAL_LOGPATH.\LOC_DS_&TIMESTAMP..LOG'
												 -CONFIG 'C:\PROGRAM FILES\SASHOME\SASFOUNDATION\9.4\SASV9.CFG'"
								TASKNAME=LOC_DEAL
								STATUS=LOC_DEAL;

								WAITFOR _ALL_ AANET_DEAL LOC_DEAL;
