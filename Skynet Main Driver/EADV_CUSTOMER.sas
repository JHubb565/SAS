/*						%IF &CUSTOMER_EADV_STATUS. = NOT_COMPLETE AND &CUSTOMER_EADV_RUN_DATE. = . %THEN*/
/*							%DO; */
								...
								/*KICK OFF EADV_CUSTOMER*/
								SYSTASK COMMAND "'C:\PROGRAM FILES\SASHOME\SASFOUNDATION\9.4\SAS.EXE'
												'&CUST_FILE_PATH.\CUSTDM_1_EADV_INPUT.SAS'
												-LOG '&CUST_LOGPATH.\EADV_CUST_&TIMESTAMP..LOG'
												-CONFIG 'C:\PROGRAM FILES\SASHOME\SASFOUNDATION\9.4\SASV9.CFG'"
								TASKNAME=EADV_CUSTOMER
								STATUS=EADV_CUSTOMER;

								WAITFOR _ALL_ EADV_CUSTOMER;
