...
EXECUTE (TRUNCATE TABLE TEMPTABLES.TRANSACTION_TABLE_UPDATE) BY ORACLE;
DISCONNECT FROM ORACLE;
QUIT;

PROC SQL;
INSERT INTO TEMPTABL.TRANSACTION_TABLE_UPDATE (BULKLOAD=YES BL_LOG="&PATH.\Logs\BL_&timestamp..LOG" BL_DELETE_DATAFILE=YES 
												BL_DEFAULT_DIR="&PATHTWO.")
SELECT *
FROM TRANDM.TRANSACTION_TABLE_UPDATE;
QUIT;